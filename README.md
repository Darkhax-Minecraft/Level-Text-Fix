...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.leveltextfix', name: 'leveltextfix-neoforge-26.2', version: '26.2.0.0'
     // Fabric
     implementation group: 'net.darkhax.leveltextfix', name: 'leveltextfix-fabric-26.2', version: '26.2.0.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.leveltextfix', name: 'leveltextfix-common-26.2', version: '26.2.0.0'
}
```
...
LevelTextFix is proudly sponsored by Nodecraft! Play your favorite games with your friends using their high
